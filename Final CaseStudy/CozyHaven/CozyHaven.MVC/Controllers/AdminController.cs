...
namespace CozyHaven.MVC.Controllers
{
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> Login(AdminLogin login)
        {
            ...
            var response = await client.PostAsJsonAsync("https://localhost:44340/api/Auth/login", login);
        ...
        public async Task<IActionResult> Users()
        {
            ...
            try
            {
                var response = await client.GetAsync("https://localhost:44340/api/User");
        ...
        public async Task<IActionResult> DeleteUser(int id)
        {
            ...
            var response = await client.DeleteAsync($"https://localhost:44340/api/User/{id}");
        ...
        public async Task<IActionResult> UserDetails(int id)
        {
            ...
            var response = await client.GetAsync($"https://localhost:44340/api/User/{id}");
        ...
        public async Task<IActionResult> Hotels()
        {
            ...
            var response = await client.GetAsync("https://localhost:44340/api/Hotel");
        ...
        public async Task<IActionResult> ViewHotel(int id)
        {
            ...
            var response = await client.GetAsync($"https://localhost:44340/api/Hotel/{id}");
        ...
        public async Task<IActionResult> EditHotel(HotelViewModel model)
        {
            ...
            var response = await client.PutAsJsonAsync($"https://localhost:44340/api/Hotel/{model.Id}", model);
        ...
        public async Task<IActionResult> DeleteHotel(int id)
        {
            ...
            var response = await client.DeleteAsync($"https://localhost:44340/api/Hotel/{id}");
        ...
        public async Task<IActionResult> AddHotel(HotelViewModel model)
        {
            ...
            var response = await client.PostAsJsonAsync("https://localhost:44340/api/Hotel", model);
        ...
        public async Task<IActionResult> Bookings()
        {
            ...
            var response = await client.GetAsync("https://localhost:44340/api/Booking");
        ...
        public async Task<IActionResult> EditBooking(int id)
        {
            ...
            var response = await client.GetAsync($"https://localhost:44340/api/Booking/{id}");
        ...
        public async Task<IActionResult> EditBooking(BookingViewModel model)
        {
            ...
            var response = await client.PutAsJsonAsync($"https://localhost:44340/api/Booking/{model.Id}", model);
        ...
        public async Task<IActionResult> DeleteBooking(int id)
        {
            ...
            var response = await client.DeleteAsync($"https://localhost:44340/api/Booking/{id}");
        ...
        public async Task<IActionResult> AddBooking(BookingViewModel booking)
        {
            ...
            var response = await client.PostAsJsonAsync("https://localhost:44340/api/Booking", booking);
