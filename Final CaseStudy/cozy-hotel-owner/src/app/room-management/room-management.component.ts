...
export class RoomManagementComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.http.get(`https://localhost:44340/api/Hotel/owner/${ownerId}`, { headers }).subscribe({
      next: (hotelData: any) => {
  ...
  fetchRooms(): void {
    ...
    this.http.get<any[]>(`https://localhost:44340/api/Room/by-hotel/${this.hotelId}`, { headers }).subscribe({
  ...
  submitRoom(): void {
    ...
    this.http.post(`https://localhost:44340/api/Room`, roomData, { headers }).subscribe({
      next: () => {
  ...
  saveRoomChanges() {
    ...
    this.http.put(`https://localhost:44340/api/Room/${this.editingRoom.id}`, this.editingRoom, { headers }).subscribe({
      next: () => {
  ...
  deleteRoom(roomId: number): void {
    ...
    this.http.delete(`https://localhost:44340/api/Room/${roomId}`, { headers }).subscribe({
      next: () => {
