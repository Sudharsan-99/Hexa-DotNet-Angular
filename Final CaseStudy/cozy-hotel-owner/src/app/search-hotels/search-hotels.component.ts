...
export class SearchHotelsComponent {
  ...
  searchHotels(): void {
    ...
    this.http.get<Hotel[]>(`https://localhost:44340/api/Hotel/location?location=${this.location}`, { headers })
      .subscribe({
  ...
  bookHotel() {
    ...
    this.http.post('https://localhost:44340/api/Booking', this.bookingDetails, { headers }).subscribe({
      next: () => {
